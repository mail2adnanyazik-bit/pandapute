...
static const int _count = sizeof(_settings) / sizeof(_settings[0]);
...
void app_settings_key(uint8_t mod, uint8_t key) {
    ...
    else if (key == KEY_DOWN && _selected < _count - 1) _selected++;
